...
class ContextPropertyTest {
    ...
    @Property
    void select_ambiguousIdWithoutQualifier_alwaysFails(
            @ForAll @From("usersColumns") String usersCol,
            @ForAll @From("ordersColumns") String ordersCol
    ) {
        Assume.that(usersCol.equalsIgnoreCase("id") && ordersCol.equalsIgnoreCase("id"));
