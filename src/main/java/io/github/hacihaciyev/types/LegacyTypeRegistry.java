...
public class LegacyTypeRegistry {
    ...
    private static Class<?> singleComponentOfRecord(Class<?> clazz) {
        ...
        return RECORD_COMPONENT_TYPES.computeIfAbsent(clazz, cls -> {
            ...
            RECORD_ACCESSORS.computeIfAbsent(cls, LegacyTypeRegistry::createRecordAccessor);
    ...
    private static MethodHandle singleRecordMethodHandle(Object param) {
        ...
        return RECORD_ACCESSORS.computeIfAbsent(clazz, LegacyTypeRegistry::createRecordAccessor);
    }
